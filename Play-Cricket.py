...
print('\nNumber generated by computer is', computer_toss)
...
if user_won_toss:
    user_dec = int(input("Would you like to Bat or Bowl?\nPress '0' for bat or '1' for bowl..."))
...
def game(chase, first_ing):
    ...
    while not_out:
        ...
        if user_num == compt_num:
            ...
            not_out = False
            # prints total
            print('Howwzzaaatt...! Score is', total)
            # breaks loop
            break
...
if user_bat:
    ...
    print('You have scored', first_ing, '. Very good!\nNow its my turn to bat and beat your score.')
    print('I need to score', first_ing + 1, 'to win.')
...
# if computer bats first
    ...
    print('I have scored', first_ing, '. Very good!\nNow its your turn to bat and beat my score.')
    print('You need to score', first_ing + 1, 'to win.')
...
if computer_bat_sec_ing:
    ...
    if first_ing > second_ing:
        print("Congratulations! You have beaten me! I lost!")
    # TIE
    elif first_ing == second_ing:
        print('Our scores are similar. Its a TIE!')
    # LOOSE
    else:
        print("Unfortunately you have lost! I won!")
